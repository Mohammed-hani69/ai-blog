...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, adminProfile }) => {
  const menuItems = [
    ...
    { id: 'all-posts', label: 'جميع المقالات', icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z' },
    ...
    { id: 'profile', label: 'إعدادات الحساب', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  ];
    ...
    <div className="w-64 h-screen bg-slate-900 text-white flex flex-col fixed right-0 top-0 z-50 font-sans shadow-2xl">
      ...
      <div className="p-4 border-t border-slate-800">
        ...
        <div className="mt-4 flex items-center space-x-3 space-x-reverse">
          <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-blue-400 to-purple-500 border-2 border-slate-700 flex items-center justify-center text-xs font-bold text-white overflow-hidden">
             {adminProfile.avatarUrl ? <img src={adminProfile.avatarUrl} alt={adminProfile.name} className="w-full h-full object-cover" /> : adminProfile.name[0]}
          </div>
          <div>
